...
The : is unknown to me at the moment, but we're running another function that is returning a fetch command. And for this example, it's to our localhost (laptop) and targetting
